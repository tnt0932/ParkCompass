(function ($) {
    $.fn.storeLocator = function (options) {
        ...
        var settings = $.extend({
            'mapDiv': 'map_canvas',
            'listDiv': 'search_results',
            'formID': 'location_search_input',
            'pinColor': 'fe7569',
            'startPinColor': '66bd4a',
            'pinTextColor': '000000',
            'storeLimit': 10,
            'distanceAlert': 60,
            'xmlLocation': 'parkcompass.xml',
            'addressErrorMsg': 'Please enter valid address address or postcode',
            'googleDistanceMatrixDestinationLimit': 25,
            'defaultLat': 49.3,
            'defaultLng': -123,
            'defaultLocationName': 'Vancouver, British Columbia'
        }, options);
                                ...
                                if (!success) { //something went wrong
                                    ...
                                    $(function () {
                                        ...
                                        function listClick(letter, shop) {
                                            ...
                                            + "<div class=\"loc-name\">" + shop.Name + "<\/div> <div class=\"loc-addr\">" + shop.nName + "<\/div>"
